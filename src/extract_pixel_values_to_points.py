...
if __name__ == '__main__':
    ...
    if True:
        ...
        OUTPUT_PATH = Path(r'C:\Users\brevi\Documents\All_Files\2022_2024_Non_Harvard\Work_with_Ian_Paynter\Locating_PR_Power_Infrastructure_in_NTL_Pixels\outputs')
    ...
    if False:
        ...
        save_as_pickle(
            a_file=pp_gdf_with_extractions,
            path=Path(OUTPUT_PATH, "pp_gdf_with_extractions_df.pkl")
        )
